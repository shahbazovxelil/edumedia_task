...
// $(document).ready(function()
// {
//     var uri = location.href.split('/')[4];

//     $('#kt_aside_menu .menu-nav > li').removeClass('menu-item-active menu-item-open');
//     $('#kt_aside_menu .menu-nav #' + uri).addClass('menu-item-active menu-item-open');
// });